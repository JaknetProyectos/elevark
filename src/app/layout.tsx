...
export const metadata: Metadata = {
  title: "Elevark | Marketing Digital Integral",
  description:
    "En Elevark, creemos que cada pixel tiene un propósito. Desde branding hasta marketing digital, nuestros expertos están listos para llevar tu proyecto al próximo nivel.",
};
